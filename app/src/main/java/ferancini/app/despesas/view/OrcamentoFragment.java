...
public class OrcamentoFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        DespesaListAdapter adapterDesp = new DespesaListAdapter(v.getContext(), Despesa.getAllDespesas());
        recyclerV.setAdapter(new DespesaListAdapter(v.getContext(), Despesa.getAllDespesas()));
        return v;
    }
}